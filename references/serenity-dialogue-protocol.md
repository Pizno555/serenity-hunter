...
- Why is the market pricing this wrong — is it a narrative gap, a category gap, or a timing gap?
- What is the next source we should check?

## Exit condition

The partner-mode conversation reaches a natural pause when the user can articulate four things:
...
If any of these is missing, ask the next question.
