...
```text
Use serenity-hunter to deeply research [market] [theme].
...
```text
用 serenity-hunter 深度调研现在 A 股 [行业/主题]。
...
```text
Use serenity-hunter to research US-listed [theme] companies.
...
```text
Use serenity-hunter to challenge [company/ticker].
...
```text
Use serenity-hunter to compare [A], [B], and [C].
...
```text
Use serenity-hunter's local scorecard to score [company].
